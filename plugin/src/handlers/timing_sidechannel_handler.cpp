...
void register_timing_sidechannel_routes(c_http_router& router) {
    router.post("/api/timing_side/find_rdtsc_checks", [](const httplib::Request&, httplib::Response& res) {
        json result;
    ...
    router.post("/api/timing_side/profile_pmc_usage", [](const httplib::Request&, httplib::Response& res) {
        json result;
    ...
    router.post("/api/timing_side/detect_cache_timing_checks", [](const httplib::Request&, httplib::Response& res) {
        json result;
