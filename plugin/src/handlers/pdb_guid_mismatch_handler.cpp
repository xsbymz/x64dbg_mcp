...
void register_pdb_guid_mismatch_routes(c_http_router& router) {
    router.post("/api/pdb_guid/extract_debug_info", [](const httplib::Request& req, httplib::Response& res) {
    ...
    router.post("/api/pdb_guid/compare_with_symbol_server", [](const httplib::Request&, httplib::Response& res) {
        json result;
    ...
    router.post("/api/pdb_guid/check_known_malware_guids", [](const httplib::Request&, httplib::Response& res) {
        json result;
