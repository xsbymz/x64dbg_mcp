...
void register_powershell_scriptblock_routes(c_http_router& router) {
    router.post("/api/ps_scriptblock/extract_from_memory", [](const httplib::Request& req, httplib::Response& res) {
    ...
    router.post("/api/ps_scriptblock/decode_obfuscated_blocks", [](const httplib::Request&, httplib::Response& res) {
        json result;
    ...
    router.post("/api/ps_scriptblock/detect_amsi_bypass_patterns", [](const httplib::Request&, httplib::Response& res) {
        json result;
