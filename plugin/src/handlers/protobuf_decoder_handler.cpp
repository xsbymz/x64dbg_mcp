...
void register_protobuf_decoder_routes(c_http_router& router) {
    router.post("/api/protobuf/scan_memory", [](const httplib::Request& req, httplib::Response& res) {
    ...
    router.post("/api/protobuf/decode_wire_format", [](const httplib::Request&, httplib::Response& res) {
        json result;
    ...
    router.post("/api/protobuf/detect_grpc_c2", [](const httplib::Request&, httplib::Response& res) {
        json result;
