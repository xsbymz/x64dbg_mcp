...
void register_moniker_activation_routes(c_http_router& router) {
    router.post("/api/moniker/trace_activations", [](const httplib::Request&, httplib::Response& res) {
        json result;
    ...
    router.post("/api/moniker/decode_display_names", [](const httplib::Request& req, httplib::Response& res) {
    ...
    router.post("/api/moniker/detect_fileless_activation", [](const httplib::Request&, httplib::Response& res) {
        json result;
