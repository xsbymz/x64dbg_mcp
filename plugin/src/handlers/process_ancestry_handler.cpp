...
void register_process_ancestry_routes(c_http_router& router) {
    router.post("/api/proc_ancestry/build_full_tree", [](const s_http_request& req) -> s_http_response {
        json result;
    ...
    router.post("/api/proc_ancestry/detect_anomalous_relationships", [](const s_http_request& req) -> s_http_response {
        json result;
    ...
    router.post("/api/proc_ancestry/correlate_with_event_log", [](const s_http_request& req) -> s_http_response {
        json result;
