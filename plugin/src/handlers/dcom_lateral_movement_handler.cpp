...
void register_dcom_lateral_movement_routes(c_http_router& router) {
    router.post("/api/dcom/enumerate_remote_activations", [](const s_http_request& req) {
        json result;
    ...
    router.post("/api/dcom/detect_known_lm_clsids", [](const s_http_request& req) {
        json result;
    ...
    router.post("/api/dcom/trace_coserverinfo_connections", [](const s_http_request& req) {
        json result;
