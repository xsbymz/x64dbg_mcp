...
void register_doh_detector_routes(c_http_router& router) {
    router.post("/api/doh/detect_active_connections", [](const httplib::Request&, httplib::Response& res) {
        json result;
    ...
    router.post("/api/doh/scan_memory_for_doh_ips", [](const httplib::Request& req, httplib::Response& res) {
    ...
    router.post("/api/doh/correlate_resolver_bypasses", [](const httplib::Request&, httplib::Response& res) {
        json result;
