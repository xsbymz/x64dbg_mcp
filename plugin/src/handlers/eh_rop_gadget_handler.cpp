...
void register_eh_rop_gadget_routes(c_http_router& router) {
    router.post("/api/eh_rop/enumerate_handler_addresses", [](const httplib::Request& req, httplib::Response& res) {
    ...
    router.post("/api/eh_rop/extract_gadgets_from_handlers", [](const httplib::Request&, httplib::Response& res) {
        json result;
    ...
    router.post("/api/eh_rop/build_authenticated_gadget_set", [](const httplib::Request&, httplib::Response& res) {
        json result;
