...
void register_compiler_fingerprint_routes(c_http_router& router) {
    router.post("/api/compiler_fp/identify_toolchain", [](const httplib::Request& req, httplib::Response& res) {
    ...
    router.post("/api/compiler_fp/extract_version_indicators", [](const httplib::Request&, httplib::Response& res) {
        json result;
    ...
    router.post("/api/compiler_fp/detect_obfuscated_compiler_trails", [](const httplib::Request&, httplib::Response& res) {
        json result;
