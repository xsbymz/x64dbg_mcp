...
void register_peb_ldr_integrity_routes(c_http_router& router) {
    router.post("/api/peb_ldr/check_all_three_lists", [](const httplib::Request& req, httplib::Response& res) {
    ...
    router.post("/api/peb_ldr/detect_partial_unlink", [](const httplib::Request&, httplib::Response& res) {
        json result;
    ...
    router.post("/api/peb_ldr/cross_validate_module_lists", [](const httplib::Request&, httplib::Response& res) {
        json result;
