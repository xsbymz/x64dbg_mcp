...
void register_anti_disassembly_routes(c_http_router& router) {
    router.post("/api/anti_disasm/detect_overlapping_instructions", [](const httplib::Request&, httplib::Response& res) {
        json result;
    ...
    router.post("/api/anti_disasm/find_junk_prefixes", [](const httplib::Request&, httplib::Response& res) {
        json result;
    ...
    router.post("/api/anti_disasm/compare_linear_vs_recursive", [](const httplib::Request&, httplib::Response& res) {
        json result;
