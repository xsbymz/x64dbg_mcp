...
void register_cfi_analyzer_routes(c_http_router& router) {
    router.post("/api/cfi/dump_cfg_bitmap", [](const s_http_request& req) {
        json result;
    ...
    router.post("/api/cfi/find_cfg_bypass_gadgets", [](const s_http_request& req) {
        json result;
    ...
    router.post("/api/cfi/analyze_valid_call_targets", [](const s_http_request& req) {
