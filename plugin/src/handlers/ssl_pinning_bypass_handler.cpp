...
void register_ssl_pinning_bypass_routes(c_http_router& router) {
    router.post("/api/ssl_pinning/detect_pinned_hashes", [](const httplib::Request& req, httplib::Response& res) {
    ...
    router.post("/api/ssl_pinning/locate_validation_callbacks", [](const httplib::Request&, httplib::Response& res) {
        json result;
    ...
    router.post("/api/ssl_pinning/generate_bypass_strategy", [](const httplib::Request&, httplib::Response& res) {
        json result;
        result["bypass_hooks"] = {
